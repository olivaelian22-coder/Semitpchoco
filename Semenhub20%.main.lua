-- semenhub (modified script: InfiniteJump + AutoDestroyTurrets enabled)
...
local function kickPlayer()
    LocalPlayer:Kick("\ndiscord.gg/semenhub - xi loves you <3")
end
...
task.spawn(function()
    ...
    if privateBuild then
        ...
        author.Text = "discord.gg/semenhub"
    end
